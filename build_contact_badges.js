...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 80" width="800" height="80">
  <defs>
    <style>
      ...
      @keyframes pulse {
        0% { filter: drop-shadow(0 0 2px rgba(163,230,53,0.2)); }
        50% { filter: drop-shadow(0 0 8px rgba(163,230,53,0.6)); }
        100% { filter: drop-shadow(0 0 2px rgba(163,230,53,0.2)); }
      }
  ...
  <a href="https://naseerpasha.me" target="_blank" class="btn-group">
    <rect x="40" y="20" width="160" height="40" class="btn" />
    <!-- Vercel Logo approximation -->
    <polygon points="75,32 85,48 65,48" class="icon" />
    <text x="100" y="45" class="text-mono">PORTFOLIO</text>
  </a>

  <!-- Button 2: LinkedIn -->
  <a href="https://linkedin.com/in/naseer-pasha" target="_blank" class="btn-group">
    <rect x="220" y="20" width="160" height="40" class="btn" />
  ...
  <a href="mailto:contact@naseerpasha.com" target="_blank" class="btn-group">
    <rect x="400" y="20" width="160" height="40" class="btn" />
    <!-- Paper Plane Logo -->
  ...
  <a href="#" class="btn-group">
    <rect x="580" y="20" width="160" height="40" class="btn" />
    <!-- Map Pin Logo -->
