  ...
  <defs>
    <style>
      ...
      :root {
        ...
        --text-main: #0f172a;
        --accent: #2563eb;
        --wave1: rgba(37, 99, 235, 0.1);
        --wave2: rgba(37, 99, 235, 0.2);
        --wave3: rgba(37, 99, 235, 0.4);
        --wave4: rgba(37, 99, 235, 1);
      }
      ...
      @media (prefers-color-scheme: dark) {
        :root {
          ...
          --text-main: #c9d1d9;
          --accent: #58a6ff;
          --wave1: rgba(88, 166, 255, 0.1);
          --wave2: rgba(88, 166, 255, 0.2);
          --wave3: rgba(88, 166, 255, 0.4);
          --wave4: rgba(88, 166, 255, 1);
        }
      }
